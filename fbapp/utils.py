...
class OpenGraphImage:
    ...
    def __init__(self, uid, first_name, description):
        ...
        background = self.base() # init image
        self.print_on_img(background, first_name.capitalize(), 70, 50) # Ajout du nom
        # Ajout de la description :
        sentences = textwrap.wrap(description, width=60)  # textwrap découpe une chaine de caractères selon un taille sans couper les mots au milieu.
